        ...
        <div class="w3-col l8 s12">
            <div class="w3-card-4 w3-margin w3-white">
                ...
                <div class="w3-container, gray">
                    <h4>Lopen met de bal met afronden</h4>
                    <h6>Fysiek -> Snelheid</h6>
                </div>
                <div class="w3-container, gray">
                    <h4>High impact interval training</h4>
                    <h6>Fysiek -> Snelheid</h6>
                </div>
                <div class="w3-container, gray">
                    <h4>ISRT interval shuttle training</h4>
                    <h6>Fysiek -> Snelheid</h6>
                </div>
                <div class="w3-container, gray">
                    <h4>Scoren uit de draai</h4>
                    <h6>Fysiek -> Snelheid</h6>
                </div>
                <hr>
            </div>
